...
Efter avslutad träning utvärderas modellen. Detta steg är avgörande för att identifiera eventuell överträning (overfitting), där modellen memorerat specifika banor istället för att lära sig generella navigeringsprinciper. Genom visuell verifiering i en grafisk miljö analyseras bilens beteende, särskilt avseende stabilitet och förmågan att parera systemlatens, innan modellen exporteras till det fysiska fordonet.
